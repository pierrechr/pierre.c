...
# generating a challenge
    ...
    pubkey0 = scalarmult(privkey,x0)
    pubkey1 = scalarmult(privkey,x1)
    P0=E2.lift_x(pubkey0)*cofact0
    t0 = time.time()
    #d0 = discrete_log(P0,G0_,g0_,operation="+")
    d0 = P0.log(G0_)
    ...
    print("Private key recovered  : " ,(privkey == guess1) or (guess2==privkey) or ( guess3==privkey) or ( guess4==privkey))
